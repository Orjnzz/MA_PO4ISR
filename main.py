...
from opt.utils import extract_item_json_list, ndcg, extract_item_list
...
data_path = "D://9_Lab//1_Recommendation_Sys//PO4ISR_demo//ALL_dataset//bundle//processed//"
...
for depth in range(config['search_depth']):
    ...
    for prompt in beam:
        ...
        for data in batch:
            ...
            is_error = detect_error_agent.detect_error(response,data['target'])
            if is_error:
                # err+=1
                # print("- Error: ", err)
